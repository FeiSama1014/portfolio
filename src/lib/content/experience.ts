...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Same engagement: designed and launched a **cultural-tourism promotion program** linking the Bureau's **offline rail-station and in-train media terminals** with a newly-built **online content matrix** to package and market high-speed rail travel routes and tour products end-to-end",
      "Extended the same cross-channel model to a **rural-revitalization initiative** along the rail lines — a **public-benefit, non-commercial program** supporting farmers and local producers by bringing their agricultural and specialty goods to market through the combined online matrix, in-station terminals, and in-train media",
